...
/* worker_callback is the callback function for the NFQUEUE. The data must be a
 * pointer to a worker_ctx struct. */
...
void worker_set_tcp(worker_ctx *ctx, int enable, int burst_wnd, int rtt,
                    float threshold, float pace);
